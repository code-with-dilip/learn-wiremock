...
public class MoviesRestClientJunit4Test {
    ...
    public void retrieveMovieById() {
        ...
        //then
        Assert.assertEquals("Batman Begins", movie.getName());
    ...
    public void retrieveMovieById_reponseTemplating() {
        ...
        //then
        Assert.assertEquals("Batman Begins", movie.getName());
        Assert.assertEquals(8, movie.getMovie_id().intValue());
    ...
    public void retrieveMoviebyName() {
        ...
        Assert.assertEquals(4, movieList.size());
        Assert.assertEquals(castExpected, movieList.get(0).getCast());
    ...
    public void addMovie() {
        ...
        //then
        Assert.assertTrue(addedMovie.getMovie_id() != null);
    }
    ...
    public void updateMovie() {
        ...
        //then
        Assert.assertTrue(updatedMovie.getCast().contains(cast));
    }
