...
### How to connect using the certs Generated by the keytool ?

- Setting up the wire mock to use new **server-keystore.jks** thats generated by keytool command.
...
-  Setting up the **WebClient** to use the **client-truststore.jks** file.
